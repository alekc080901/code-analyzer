    ...
    def analyze_text(self, text: str) -> str:
        ...
        payload = {
            ...
            "messages": [
                ...
                {
                    "role": "user",
                    "content": f"Проанализируй следующие данные (код и трейсы) и предложи изменения в коде в формате git diff. Особенное внимание удели проблемам с производительностью и причинам длительных вызовов. На выходе должен получиться краткий список проблем и предложенные исправления в коде, которые бы могли целиком решить данные проблемы.\n\n{truncated_text}"
                }
            ],
            "temperature": 0.7
        }
